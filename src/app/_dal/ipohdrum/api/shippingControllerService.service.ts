...
export class ShippingControllerServiceService {
     ...
     */
    public createShipping(name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createShipping(name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createShipping(name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createShipping(name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateShippingByUid(uid: string, name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateShippingByUid(uid: string, name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateShippingByUid(uid: string, name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateShippingByUid(uid: string, name: string, storeId: number, price: number, maxweight: number, maxdimension: number, desc?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (uid === null || uid === undefined) {
