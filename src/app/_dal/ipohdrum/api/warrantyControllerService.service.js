...
var WarrantyControllerServiceService = /** @class */ (function () {
    function WarrantyControllerServiceService(httpClient, basePath, configuration) {
    ...
    WarrantyControllerServiceService.prototype.createWarranty = function (name, storeId, period, policy, desc, observe, reportProgress) {
        ...
        if (policy !== undefined && policy !== null) {
            queryParameters = queryParameters.set('policy', policy);
        }
        ...
        return this.httpClient.post(this.configuration.basePath + "/api/warranty", null, {
    ...
    WarrantyControllerServiceService.prototype.deleteWarrantyByUid = function (uid, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        ...
        return this.httpClient.delete(this.configuration.basePath + "/api/warranty/" + encodeURIComponent(String(uid)), {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    WarrantyControllerServiceService.prototype.filterWarranties = function (pageNumber, pageSize, keyword, fromdate, todate, status, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: this.encoder });
        ...
        return this.httpClient.get(this.configuration.basePath + "/api/filter/warranty", {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    WarrantyControllerServiceService.prototype.getWarranties = function (pageNumber, pageSize, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        var queryParameters = new http_1.HttpParams({ encoder: this.encoder });
        if (pageNumber !== undefined && pageNumber !== null) {
        ...
        return this.httpClient.get(this.configuration.basePath + "/api/warranty", {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    WarrantyControllerServiceService.prototype.getWarrantyByUid = function (uid, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (uid === null || uid === undefined) {
        ...
        return this.httpClient.get(this.configuration.basePath + "/api/warranty/" + encodeURIComponent(String(uid)), {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    WarrantyControllerServiceService.prototype.updateWarrantyByUid = function (uid, name, storeId, period, policy, desc, observe, reportProgress) {
        if (observe === void 0) { observe = 'body'; }
        if (reportProgress === void 0) { reportProgress = false; }
        if (uid === null || uid === undefined) {
        ...
        return this.httpClient.put(this.configuration.basePath + "/api/warranty/" + encodeURIComponent(String(uid)), null, {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
    ...
    WarrantyControllerServiceService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        }),
        __param(1, core_1.Optional()), __param(1, core_1.Inject(variables_1.BASE_PATH)), __param(2, core_1.Optional())
    ], WarrantyControllerServiceService);
    return WarrantyControllerServiceService;
}());
exports.WarrantyControllerServiceService = WarrantyControllerServiceService;
